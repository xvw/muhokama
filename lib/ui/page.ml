      ...
      ; form
          ...
          [ div
              ...
              ; p
                  ...
                  ; br ()
                  ; txt
                      "C'est l'adresse qui fera office d'identifiant sur le \
                       site."
                  ]
              ]
          ; div
              ...
              ; p
                  ~a:[ a_class [ "help" ] ]
                  [ txt
                      "C'est un nom d'affichage, donc il faut que ça ait l'air \
                       un peu sérieux."
                  ]
              ]
          ; div
              ...
              ; p
                  ~a:[ a_class [ "help" ] ]
                  [ txt
                      "Au minimum 7 caractères... parce que ce site est sécure."
                  ]
              ]
          ; div
              ~a:[ a_class [ "field" ] ]
              ...
              ; p
                  ~a:[ a_class [ "help" ] ]
                  [ txt
                      "Ici il faut réécrire le même mot de passe, c'est juste \
                       pour être sur."
                  ]
              ]
          ; div
